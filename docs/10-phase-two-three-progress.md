...
- Phase 2.3.25 should focus on pressure-frontier diffusion before final Phase 2.3.x acceptance; #75 remains the place to collect the final terrain-only and pressure-visible profile evidence.
